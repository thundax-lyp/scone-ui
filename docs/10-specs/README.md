...
4. 包使用、AI 生成代码或快速查公共 props 类型时，读取 [`packages/scone-ui/PACKAGE-AI-GUIDE.md`](../../packages/scone-ui/PACKAGE-AI-GUIDE.md)。
...
- `packages/scone-ui/PACKAGE-AI-GUIDE.md` 是发布包后面向 AI 和调用方的独立公共 API、props 类型、导入规则和禁止导入边界文档。
...
- [`packages/scone-ui/PACKAGE-AI-GUIDE.md`](../../packages/scone-ui/PACKAGE-AI-GUIDE.md)：包发布后的独立 AI 使用入口、公共导入规则、组件 registry、props 类型和 SPEC 路由。
