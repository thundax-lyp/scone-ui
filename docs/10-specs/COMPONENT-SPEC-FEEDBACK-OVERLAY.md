...
本规格覆盖 admin-ui 基础反馈和浮层组件。来源统计显示抽屉、提示、加载和空状态使用稳定，但组件库不绑定创建、编辑、详情等业务流程。

## Source Signals

- 抽屉使用 45 处，说明侧向浮层是重要基础能力。
- Alert 使用 51 处，说明状态提示和错误展示需要统一。
- Modal / Popconfirm 使用 12 处，说明确认和短流程弹窗需要基础封装。
- Empty、Spin、Skeleton、Progress 覆盖空态、加载、骨架和进度。
