...
- 修改 `packages/scone-ui/README.md`、`packages/scone-ui/PACKAGE-AI-GUIDE.md` 或发包文件白名单时，必须按随包发布的独立 AI 文档处理：这些文档不能依赖未随包发布的设计文档、RUNBOOK、TODO、PR 记录或源码路径才能被 AI 理解。

## Router

- 文档结构、文档写作、RUNBOOK：`00-governance/DOCUMENT-RULES.md`。
- TypeScript、React、测试和代码审阅规则：`00-governance/CODE-RULES.md`。
- TODO 协作、任务项格式、删除和收窄：`00-governance/TODO-RULES.md`。
- PR 描述、阶段性交付和验证证据：`00-governance/PR-RULES.md`。
- workspace README 和开发命令入口：根目录 `README.md`。
- 发布包 README 和 AI 安装入口：`packages/scone-ui/README.md`。
- 发布包 AI 使用入口和公共 API 生成规则：`packages/scone-ui/PACKAGE-AI-GUIDE.md`。
