...
- 修改根目录 `README.md`、`PACKAGE-AI-GUIDE.md` 或发包文件白名单时，必须按随包发布的独立文档处理：这些文档不能依赖未随包发布的设计文档、RUNBOOK、TODO、PR 记录或源码路径才能被包消费者或 AI 理解。
...
- 发布包 README 和消费者安装入口：根目录 `README.md`。
...
- `10-specs/`: 组件库稳定规格、公共 API 说明和随包发布的 AI 使用入口。
